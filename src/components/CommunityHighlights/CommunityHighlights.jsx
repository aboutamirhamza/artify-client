...
const CommunityHighlights = () => {
  ...
  return (
    <section className="relative bg-linear-to-br from-gray-50 to-white py-10 px-6 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <h2 className="text-5xl font-black text-center text-gray-900 mb-14 font-raleway">
          Community <span className="bg-linear-to-r from-indigo-500 to-fuchsia-500 bg-clip-text text-transparent font-raleway">Highlights</span>
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          {highlights.map((artist) => (
            ...
            >
              ...
              <div className="p-6">
                <h3 className="font-bold text-lg text-gray-800 leading-tight mb-1 font-raleway">
                  {artist.title}
                </h3>
                ...
                <div className="flex items-center justify-between border-t border-gray-100 pt-3 text-gray-600 text-sm">
                  <div className="flex items-center gap-3">
                    <span className="flex items-center gap-1 font-space-mono">
